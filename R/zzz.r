...
#' @importFrom stats dist nobs optimize pchisq variable.names optim quantile rbinom cor var as.dist pnorm
#' pgamma
#' @import ggplot2
#' @import dartR.data
...
# WELCOME MESSAGE [no longer necessary due to dartRverse
#.onAttach <- function(...) {
  #  packageStartupMessage(important(
  #      paste(
  #          "**** Welcome to dartR.base [Version",
