...
{"function": "gl.sort", "package": "dartR.base", "family_mode": "modify",
 ...
 "findings": [
  {"id": "F1", "severity": "MEDIUM", "rules": ["FS8"], "loc": "R/gl.sort.r history", "status": "proposed"},
  {"id": "F2", "severity": "MEDIUM", "rules": ["FS", "VRB"], "loc": "R/gl.sort.r end block", "status": "proposed"},
  {"id": "F3", "severity": "LOW", "rules": ["DOC2", "STY"], "loc": "R/gl.sort.r", "status": "proposed"}],
