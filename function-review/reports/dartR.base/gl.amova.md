...
## Relocation addendum (2026-09-07)

gl.amova moved to dartR.popgen at the custodian's direction: the reviewed code (this report's applied state, PR #378) and its characterization test now live there (green-striped-gecko/dartR.popgen#88, with dartR.base's internal FBM probe inlined and StAMPP/pegas declared). PR #378 is superseded by the move pair; this report remains the campaign record.
