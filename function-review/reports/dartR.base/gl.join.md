...
{"function": "gl.join", "package": "dartR.base", "family_mode": "io",
 ...
 "findings": [
  {"id": "F1", "severity": "HIGH", "rules": ["DAT2", "DAT3"], "loc": "R/gl.join.r loc path", "status": "proposed"},
  {"id": "F2", "severity": "MEDIUM", "rules": ["DAT4"], "loc": "R/gl.join.r flags", "status": "proposed"},
  {"id": "F3", "severity": "MEDIUM", "rules": ["STY", "VRB"], "loc": "R/gl.join.r flags/warnings", "status": "proposed"},
  {"id": "F4", "severity": "LOW", "rules": ["DAT", "DOC"], "loc": "R/gl.join.r", "status": "proposed"}],
