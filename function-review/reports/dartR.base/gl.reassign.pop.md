...
{"function": "gl.reassign.pop", "package": "dartR.base", "family_mode": "modify",
 ...
 "findings": [
  {"id": "F1", "severity": "MEDIUM", "rules": ["spec", "DAT"], "loc": "R/gl.reassign.pop.r as.pop", "status": "proposed"},
  {"id": "F2", "severity": "LOW", "rules": ["VRB", "DOC"], "loc": "R/gl.reassign.pop.r", "status": "proposed"}],
