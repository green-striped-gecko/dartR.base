...
All three findings approved via the approval boxes (2026-08-31); F2 approved as a behaviour change (fatal on missing old populations).

## Outcome

All applied. Suite 13/13; flipped assertions map to F1 (empty old fatal at verbose 0) and F2 (nonexistent old fatal). Verbose-3 end-to-end clean. Caller check: gl.collapse (dartR.popgen) merges only names taken from popNames -- unaffected.
...
{"function": "gl.merge.pop", "package": "dartR.base", "family_mode": "modify",
 ...
 "findings": [
  {"id": "F1", "severity": "MEDIUM", "rules": ["VRB"], "loc": "R/gl.merge.pop.r validation", "status": "applied"},
