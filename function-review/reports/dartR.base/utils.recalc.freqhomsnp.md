# Review: utils.recalc.freqhomsnp (dartR.base)

## Provenance

- Model: claude-fable-5 (Claude Code); Skill: dartr-function-review
  v2.0.0; Base: dev at ddaed27; Branch: review-utils.recalc.freqhomsnp. Reviewed as part
...
- **Spec: FAIL** — SilicoDArT input runs through the diploid 0/1/2
  arithmetic silently (presence/absence data given a homozygous-alternate frequency); the metric itself is verified exact
...
seealso corrected; creation-message gate standardised.

## Coverage

test-utils.recalc.freqhomsnp.R — 5 assertions (recomputation anchor, flags-crash
...
and SilicoDArT. PR #305.

```json
{"function": "utils.recalc.freqhomsnp", "package": "dartR.base", "family_mode": "analysis",
 "commit": "ddaed27", "skill_version": "2.0.0",
 "verdict_standards": "FAIL", "verdict_spec": "FAIL",
 "findings": [{"id": "B2", "severity": "MEDIUM", "rules": ["spec"], "loc": "R/utils.recalc.freqhomsnp.r monomorphs check", "status": "applied"},
  {"id": "B3", "severity": "MEDIUM", "rules": ["spec", "DAT"], "loc": "R/utils.recalc.freqhomsnp.r datatype", "status": "applied"},
  {"id": "B1", "severity": "LOW", "rules": ["DOC"], "loc": "R/utils.recalc.freqhomsnp.r visibility", "status": "applied"},
  {"id": "B4", "severity": "LOW", "rules": ["DOC"], "loc": "R/utils.recalc.freqhomsnp.r docs", "status": "applied"}],
 "datasets": ["testset.gl", "testset.gs"],
 "baseline_test": "tests/testthat/test-utils.recalc.freqhomsnp.R",
 "pr": 305}
```
