...
{"function": "gl.reassign.ind", "package": "dartR.base", "family_mode": "modify",
 ...
 "findings": [
  {"id": "F1", "severity": "LOW", "rules": ["STY"], "loc": "R/gl.reassign.ind.r stops", "status": "proposed"},
  {"id": "F2", "severity": "LOW", "rules": ["VRB", "STY"], "loc": "R/gl.reassign.ind.r selection", "status": "proposed"}],
 "datasets": ["testset.gl"],
